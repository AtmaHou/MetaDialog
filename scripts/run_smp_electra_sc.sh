                          ...
                          do
                                ...
                                do
                                    ...
                                    do
                                        ...
                                        do
                                            # model names
                                            model_name=sc.ga_${grad_acc}_ple_${ple_scale_r}.bs_${train_batch_size}.electra.${task}.sim_${similarity}.ems_${emission}_${emission_normalizer}.${use_schema}--fix_dev_spt${do_debug}
